...
public class QuestionMapperFactory {
    ...
    public TypedQuestionMapper<? extends QuestionRequest, ? extends QuestionEntity, ? extends QuestionResponse, ? extends UpdateQuestionRequest> getByType(QuestionEntity.QuestionType type) {
